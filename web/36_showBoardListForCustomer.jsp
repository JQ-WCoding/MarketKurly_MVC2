...
<p>
    ...
    <a href="${contextPath}/showBoardListForCustomer.do?curPageNum=${startPage - clickablePageSize}"
       class="aList">[이전]</a>
    </c:if>
    <c:forEach var="i" begin="${startPage}" end="${endPage}">
    <a href="${contextPath}/showBoardListForCustomer.do?curPageNum=${i}" class="aList">${i}</a>
    </c:forEach>
